...
<head>
	...
	<title>Online Student Faculty Feedback System</title>
...
<span style="margin-left: 120px"><img src="images/student.png" style="border-radius: 30px">
</span>
<span style="margin-left: 120px"><img src="images/faculty.png" style="border-radius: 30px">
</span>
<span style="margin-left: 100px"><img src="images/admin.png"></span>
<br><br><br>
...
<span style="margin-left: 170px"> <a href="index.php?info=faculty_login"> <input type="button" value="Faculty Login" style="width: 160px;height: 50px;background-color: #fc0366;color: white;border-radius: 5px;font-weight: bold" ></a></span>

<span style="margin-left: 150px"> <a href="admin"> <input type="button" value="Admin Login" style="width: 160px;height: 50px;background-color: #fc0366;color: white;border-radius: 5px;font-weight: bold" ></a></span><br><br><br>
<span style="margin-left: 450px;"> <a href="index.php?info=registration"> <input type="button" value="Create Account" style="width: 250px;height: 60px;background-color: #36a832;color: white;border-radius: 5px;font-weight: bold" ></a></span>
			</div>
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:20px;height:60px; background:#0366fc">
		<span style="color:#FFFFFF">Powerd By <a href="http://www.ubdtce.org" style="text-decoration: none;font-weight:bold;color: white">UBDTCE</a> </span>
	</div>
    <!-- jQuery -->
